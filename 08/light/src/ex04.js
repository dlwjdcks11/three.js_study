...
export default function example() {
	...
	const light = new THREE.SpotLight('white', 1, 30, Math.PI / 6); // 색, 강도, 빛이 영향을 미치는 최대 거리, 각도(원뿔의 꼭짓점 radian 각)
    light.position.x = -5;
	light.position.y = 3;
	...
	const lightHelper = new THREE.SpotLightHelper(light); // 시각적으로 조명이 어딨는지 보여준다.
