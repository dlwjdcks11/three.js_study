...
export default function example() {
    ...
    // Ambient와 비슷한 느낌이다.
    // 하늘과 땅에서 동시에 2개의 색의 빛을 쏜다고 생각하면 편하다.
	const light = new THREE.RectAreaLight('orange', 10, 2, 2); // 색, 강도, 사각형 영역의 크기 
    // light.position.x = -5;
	light.position.y = 2;
	light.position.z = 3;
    
    // HemisphereLight는 그림자가 없다.
	...
	const lightHelper = new RectAreaLightHelper(light); // 시각적으로 조명이 어딨는지 보여준다. RectAreaHelper는 따로 import 해야함.
