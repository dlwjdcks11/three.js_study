...
export default function example() {
    ...
    const box2 = box1.clone(); // 지구. 같은 mesh라면 똑같이 geometry, material 사용해도 되지만, clone을 쓰는것도 된다.
    box2.scale.set(0.3, 0.3, 0.3);
    group2.position.x = 2;
    
    const group3 = new THREE.Group(); // Group() 대신에 Object3()도 가능하다.
    ...
    group1.add(box1, group2); // add는 복수 패러미터 가능
    scene.add(group1);
