...
const example = () => {
    ...
    renderer.setClearColor(0x00FF00); // '#00FF00' 처럼도 ㄱㄴ
    renderer.setClearAlpha(0.5); // 배경색 투명도

    // Scene (무대)
    const scene = new THREE.Scene();
    scene.background = new THREE.Color('#0000FF'); // 이거 설정하면 renderer 색적용은 다 씹힌다. 투명같은거 하고싶으면 renderer에서 하자.
